...
if (!isset($_SESSION['id']) || !isset($_SESSION['tipo_usuario']) || $_SESSION['tipo_usuario'] !== 'crianca') {
    header('location: login.html');
    exit;
}

// Dados do aluno logado
$crianca_id = $_SESSION['id'];
$crianca_nome = isset($_SESSION['nome']) ? $_SESSION['nome'] : 'Crianca';
$id_resp = isset($_SESSION['id_resp']) ? $_SESSION['id_resp'] : '';

// Debug - pode ser removido depois
error_log("Crianca logada - ID: $crianca_id, Nome: $crianca_nome, Inst: $id_resp");
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<head>
    ...
    <title>LevelUp - Menu Criança</title>
...
<body>
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="top-bar">
                <div class="greeting">
                    <h2 id="greeting-name">Olá, <?php echo explode(' ', $crianca_nome)[0]; ?>!</h2>
                ...
                <div class="user-info">
                    ...
                    <div class="user-profile" id="user-profile">
                        <div class="user-avatar" id="user-avatar"><?php echo strtoupper($crianca_nome[0]); ?></div>
                        <div class="user-name" id="user-name"><?php echo explode(' ', $crianca_nome)[0]; ?></div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-overlay" id="profile-modal">
        <div class="profile-modal">
            <div class="modal-header">
                ...
                <div class="profile-avatar-large" id="modal-avatar"><?php echo strtoupper($crianca_nome[0]); ?></div>
                <div class="modal-title" id="modal-name"><?php echo $crianca_nome; ?></div>
    ...
    <script>
        // Variáveis globais com dados da crianca logada
        window.STUDENT_DATA = {
            id: '<?php echo $crianca_id; ?>',
            nome: '<?php echo addslashes($crianca_nome); ?>',
            id_resp: '<?php echo $id_resp; ?>'
        };
    </script>
